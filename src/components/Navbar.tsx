...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-bg-hover border-b border-border-strong px-6 py-4">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <div className="flex items-center gap-6">
          <Link to="/projects" className="text-xl font-bold text-text-primary hover:text-blue-500 dark:text-blue-400 transition-colors">ACSE</Link>
          {location.pathname !== '/projects' && location.pathname !== '/dashboard' && (
            <button onClick={() => navigate('/projects')} className="text-sm text-text-secondary hover:text-text-primary bg-bg-hover px-3 py-1 rounded">
