    ...
    <div className="flex-1 bg-transparent p-6 md:p-10 relative overflow-hidden">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <div className="flex items-center gap-2 text-xs text-teal-500 dark:text-teal-400 mb-1">
          ...
          <div className="flex gap-3">
            <Link
              to={`/projects/${id}`}
              className="px-4 py-3 bg-slate-500 hover:bg-slate-600 text-text-secondary rounded-xl text-xs font-semibold border border-border-strong transition-colors"
            >
              Cockpit
            </Link>
            {/* <Link
              to={`/projects/${id}/baseline`}
              className="px-4 py-3 bg-purple-600/80 hover:bg-purple-600 text-text-primary rounded-xl text-xs font-semibold transition-colors"
            >
              Baseline Review
            </Link>
            <Link
              to={`/projects/${id}/tracker`}
              className="px-4 py-3 bg-rose-600/80 hover:bg-rose-600 text-text-primary rounded-xl text-xs font-semibold transition-colors"
            >
              Risk Tracker
            </Link> */}
          </div>
